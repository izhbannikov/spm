#'Multi-dimension simulation function for Genetic SPM (multidimensional GenSPM) with discrete-time intervals
...
#' head(data)
#'
simdata_gen_discr <- function(N=100, a=-0.05, f1=80, Q=2e-8, f=80, b=5, mu0=1e-5, theta=0.08, ystart=80, tstart=30, tend=105, dt=1, p0=0.25) {
