...
The package offers following five hypotheses to test for \code{spm_time_dep(...)} function (CITE Arbeev):
...
```H03```: $f_1(t) = 0$ (i.e., $a_{f1} = 0$ and $b_f1 = 0$).

```H04```: $f_1(t) = a_{f_1}$ (i.e., $b_{f_1} = 0$).

```H05```: $a(t) = a_Y$ (i.e., $b_Y = 0$).

To perform hypothesis testing you should put the variable \code{lrtest} to \code{TRUE} (\code{"H01"} by default) or to any of the following: \code{"H01"}, \code{"H02"}, \code{"H03"}, \code{"H04"}, \code{"H05"}.
...
res <- spm_time_dep(data, verbose=F, 
                    ...
                    maxeval = 2, ftol_rel = 1e-12), lrtest="H01")

res$res$lr.test.pval
...
res <- spm_time_dep(data, verbose=F, 
                    ...
                    ub=c(a=0, f1=120, Q=1e-7, f=150, b=10, mu0=1e-2),
                    opts = list(algorithm = "NLOPT_LN_NELDERMEAD", 
                    maxeval = 2, ftol_rel = 1e-12), lrtest="H02")
res$res$lr.test.pval
...
res <- spm_time_dep(data, verbose=F, 
                    ...
                    ub=c(a=0, f1=120, Q=1e-7, f=150, b=10, mu0=1e-2),
                    opts = list(algorithm = "NLOPT_LN_NELDERMEAD", 
                    maxeval = 2, ftol_rel = 1e-12), lrtest="H03")
...
res <- spm_time_dep(data, verbose=F, 
                    ...
                    ub=c(a=0, f1=120, Q=1e-7, f=150, b=10, mu0=1e-2),
                    opts = list(algorithm = "NLOPT_LN_NELDERMEAD", 
                    maxeval = 2, ftol_rel = 1e-12), lrtest="H04")
...
res <- spm_time_dep(data, verbose=F, 
                    ...
                    start=list(a=-0.05, f1=80, Q=1e-8, f=90, b=5, mu0=0.001), 
                             ...
                             ub=c(a=0, f1=120, Q=1e-7, f=150, b=10, mu0=1e-2),
                             opts = list(algorithm = "NLOPT_LN_NELDERMEAD", 
                                         maxeval = 2, ftol_rel = 1e-12), lrtest="H05")
res$res$lr.test.pval
```
