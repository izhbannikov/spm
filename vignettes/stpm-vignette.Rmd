...
Below there is an example of clinical data that can be used in ```stpm``` and we will discuss the field later.
...
```simdata_cont(N=100, a=-0.05, f1=80, Q=2e-07, f=80, b=5, mu0=2e-05, theta=0.08, ystart=80, tstart=30, tend=105)```
...
## SPM with genetic component: GenSPM
